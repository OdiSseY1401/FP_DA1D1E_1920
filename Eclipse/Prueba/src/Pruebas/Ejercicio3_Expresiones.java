...
public class Ejercicio3_Expresiones {
	public static void main(String[] args) {
		float a=1, b=-5, c=6, m=4, n =6, p=7, q=8, r=3;
		
	System.out.println("\n3.- Realizar las conversiones de expresiones matemáticas a expresiones algorítmicas indicando el orden de ejecución de cada una de ellas");
