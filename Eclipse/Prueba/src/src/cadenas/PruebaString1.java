...
public class PruebaString1 {
	public static void main(String[] args) {
        ...
        System.out.println(cadena.lastIndexOf("i"));  //Nos devuelve la posicion de la última i (72)
        ...
        for (int i=0;i<array_bytes.length;i++){
            ...
            System.out.print((char)array_bytes[i] + " "); //Muestra la letra que corresponde cada caracter
        }
